          ...
          <div className="w-full md:w-1/2 p-4 md:p-6 order-1 md:order-2">
            ...
            <div className="space-y-8 md:mt-6 md:px-4">
              <div>
                ...
                <a
                  className="text-xl md:text-2xl hover:cursor-pointer font-extrabold"
                  href="tel:(365) 987-4165"
                >
                  +1 (365) 987-4165
                </a>
              </div>
              ...
              <div>
                ...
                <a
                  className="text-xl hover:cursor-pointer md:text-xl font-extrabold break-words"
                  href="mailto:customs.midnightclub@gmail.com"
                >
                  customs.midnightclub@gmail.com
                </a>
              </div>
              ...
              <div>
                ...
                <a
                  className="text-xl md:text-xl lg:text-xl hover:cursor-pointer font-extrabold"
                  target="_blank"
                  href="https://maps.app.goo.gl/Usw19Lxx2RztaGWLA?g_st=com.google.maps.preview.copy"
                >
                  365 Healey Rd #15, Bolton, ON L7E 5C1
                </a>
              </div>
            </div>
          </div>
